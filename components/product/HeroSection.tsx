                            ...
                            <div className="space-y-3">
                                ...
                                {data.price.discountPercent && (
                                    <div className="text-center">
                                        <span className="inline-block bg-green-600 text-white text-sm font-bold px-4 py-1.5 rounded-full shadow-lg">
                                            UP TO {data.price.discountPercent}% OFF
                                        </span>
                                    </div>
                                )}
                                ...
                                {isPrebook ? (
                                    <button
                                        ...
                                        className="w-full bg-black text-white py-4 px-8 text-lg font-bold tracking-wide hover:bg-gray-900 hover:scale-105 transition-all duration-300 relative overflow-hidden group"
                                    >
                                        {/* Shimmer effect */}
