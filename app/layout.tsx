...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <head>
        {/* Meta Pixel Code — must be in <head> so Pixel Helper detects it */}
        <script
      ...
      >
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-WMPHN6CZ');
            `,
          }}
        />
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WMPHN6CZ"
            height="0"
            width="0"
